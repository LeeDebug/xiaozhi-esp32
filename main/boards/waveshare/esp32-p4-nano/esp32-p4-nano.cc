...
private:
    ...
    void InitializeTouch()
    {
        ...
        // NOTE: Only ONE reader is allowed for the touch controller - LVGL.
        // `lvgl_port_add_touch` registers the indev read callback that calls
        // esp_lcd_touch_read_data() itself; polling the same handle from another
        // task/timer races with it over I2C and corrupts the touch data.
